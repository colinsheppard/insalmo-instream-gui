...
public class ShowErrorsWarnings extends javax.swing.JFrame {
    ...
    private void initComponents() {
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(insalmo_instream_gui.InSTREAMConfigApp.class).getContext().getResourceMap(ShowErrorsWarnings.class);
