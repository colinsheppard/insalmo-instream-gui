 ...
 */
public class InsalmoInstreamGui extends JFrame implements ActionListener{
	// Check that we are on Mac OS X.  This is crucial to loading and using the OSXAdapter class.
	public static boolean MAC_OS_X = (System.getProperty("os.name").toLowerCase().startsWith("mac os x"));
	protected JDialog aboutBox, prefs;
	private static InsalmoInstreamView view;

	public InsalmoInstreamGui(){
		super(MetaProject.getInstance().getAppTitle());

		this.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
		this.view = new InsalmoInstreamView(this);
		ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(insalmo_instream_gui.InSTREAMConfigApp.class).getContext().getResourceMap(InsalmoInstreamGui.class);
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				new InsalmoInstreamGui().setVisible(true);
			}
		});
