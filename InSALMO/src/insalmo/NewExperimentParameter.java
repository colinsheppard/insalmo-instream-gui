...
public class NewExperimentParameter extends javax.swing.JFrame {
    ...
    /** Creates new form */
    public NewExperimentParameter(InSALMOView parent, Project openProject) {
        this.parent = parent;
    ...
    private void initComponents() {
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(insalmo.InSTREAMConfigApp.class).getContext().getResourceMap(NewExperimentParameter.class);
