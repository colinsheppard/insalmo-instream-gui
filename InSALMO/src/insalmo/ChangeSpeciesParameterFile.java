...
//	private JLabel projectNewMethodLabel = new JLabel();
	...
	public ChangeSpeciesParameterFile(InSALMOView parent, Project openProject, Integer speciesIndex) {
		this.parent = parent;
	...
	private void initComponents() {
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(insalmo.InSTREAMConfigApp.class).getContext().getResourceMap(ChangeSpeciesParameterFile.class);
