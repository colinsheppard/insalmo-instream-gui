inSALMO/inSTREAM Graphic User Interface Version 1.2.2, October 2012.

This software provides an interface for using version 1.2.2 of the inSALMO and inSTREAM individual-based salmon model. The model represents effects of river habitat on freshwater life stages of salmon, from spawning through outmigration of juveniles.
...
For documentation on using the GUI see the contents of Help/inSALMO_GUI_Guide.chm
